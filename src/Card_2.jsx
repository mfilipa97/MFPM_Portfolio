...
const Card_2 = ({ jobTitle, jobSummaryTitle, buttonLabel, icon, onButtonClick }) => {
    return (
        <StyledWrapper>
            <article className="card">
                <section className="card__hero">
                    ...
                    <p className="card__job-title">{jobTitle}</p>
                </section>
                <footer className="card__footer">
                    ...
                    <button className="card__btn" onClick={onButtonClick}>{buttonLabel}</button>
                </footer>
            </article>
        </StyledWrapper>
    );
...
const StyledWrapper = styled.div`
    .card {
        ...
        border-radius: 1rem;
        border-color: #f3d9c1;
        box-shadow: 5px -5px 0px rgb(243, 217, 193);
    }
