...
import CuteModal from "./modal/CuteModal.jsx"; // Import the CuteModal component
...
const About = () => {
    ...
    const hobbies = [
        {
            src: 'src/assets/img/face-1-svgrepo-com.svg',
            alt: 'Food',
            description: 'I’m all about food—every bite’s an adventure. I love trying new flavors, cooking up something fun, and just enjoying the simple joy of a good meal. Food is my happy place.'
        },
        {
            src: 'src/assets/img/simulation-svgrepo-com.svg',
            alt: 'Gaming',
            description: 'Gaming is my escape. I love getting lost in new worlds, challenging myself, and just having fun with it. Whether I’m diving into a story or competing in a game, it’s all about the thrill and the experience.'
        },
        {
            src: 'src/assets/img/sleeping-face-svgrepo-com.svg',
            alt: 'Sleeping',
            description: 'Sleep is my little sanctuary. I love the feeling of being wrapped up in the warmth of my blankets, letting go of everything, and just drifting into peaceful rest. It’s the quiet moment where I can truly feel at peace, fully recharging and ready to start fresh.'
        },
        {
            src: 'src/assets/img/suitcase-svgrepo-com.svg',
            alt: 'Traveling',
            description: 'Traveling is something I dream about. Even though I haven’t had the chance to leave my country yet, I love imagining all the places I could visit—each one with its own culture, landscapes, and experiences. There’s something exciting about the idea of exploring new places and connecting with the world beyond my own. '
        }
    ];
                ...
                <div className="about-me-row">
                    ...
                    <div className="about-content-wrapper">
                        <p>
                            ...
                            <span className="hover-underline"> Linguistics <img
                                src="/src/assets/img/person-reading-a-book-question-mark-svgrepo-com.svg"
                                alt="coding emoji"
                                style={{ width: '30px', height: '30px', verticalAlign: 'middle' }}
                            /> </span>.

                            I love exploring new technologies and solving challenges through code.<img
                            src="/src/assets/img/female-programmer-upper-body-svgrepo-com.svg"
                            alt="coding emoji"
                            style={{ width: '30px', height: '30px', verticalAlign: 'middle' }}
                        />
                        </p>
                        ...
                        <p>
                            Let's connect?
                            <img
                                src="/src/assets/img/incoming-mail-svgrepo-com.svg"
                                alt="coding emoji"
                                style={{ width: '30px', height: '30px', verticalAlign: 'middle' }}
                            />
                        </p>
                    ...
                    <h3>Hobbies
                        <img
                            src="/src/assets/img/woman-with-a-cane-svgrepo-com.svg"
                            alt="coding emoji"
